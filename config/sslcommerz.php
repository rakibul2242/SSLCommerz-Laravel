...
return [
    ...
    'apiDomain' => env('SSLCOMMERZ_API_DOMAIN', 'https://sandbox.sslcommerz.com'),
    ...
    'payment_mode' => env('SSLCOMMERZ_PAYMENT_MODE', 'hosted'),

    // URL Redirection for SSLCommerz
    'success_url' => env('SSLCOMMERZ_SUCCESS_URL', '/payment/success'),
    'failed_url' => env('SSLCOMMERZ_FAILURE_URL', '/payment/failure'),
    'cancel_url' => env('SSLCOMMERZ_CANCEL_URL', '/payment/cancel'),
    'ipn_url' => env('SSLCOMMERZ_IPN_URL', '/payment/ipn'),

    'connect_from_localhost' => env('SSLC_ALLOW_LOCALHOST', true),
